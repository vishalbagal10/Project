...
// log started
$file = "logs/get_asset_data_callback/get_asset_data_callback_log_".date('Y-m-d').".log";
if(!is_file($file)){
    //Some simple example content.
    $contents = date('Y-m-d h:i:s');
    //Save our content to the file.
    file_put_contents("logs/get_asset_data_callback/get_asset_data_callback_log_".date('Y-m-d').".log", $contents);
}
...
// error_log("ASSET ID3".$asset_cs_id);
// $extract_asset_result_data_from_received_response_status = extract_asset_result_data_from_received_response($conn, $response_content, $dbcon, $asset_cs_id, $present_at_splitter, $splitter_id, $cs_status_datetime);
